namespace Galacticraft {
    export namespace Renderer {
        ...
        export function setMachineConnecting(id: number, boxes: Galacticraft.Renderer.IWireBoxDescription[], render: ICRender.Model, shape: ICRender.CollisionShape, commonGroupName: string): void {
