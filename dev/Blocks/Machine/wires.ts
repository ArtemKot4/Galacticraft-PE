var WIRE = Block.createSpecialType({
    destroytime: 0.1,
    explosionres: 0.5,
    sound: "cloth",
});
...
TileRenderer.setupWireModel(BlockID.PipeOxygenWhite,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenGray,0, 2/8,"ob-wire");;
...
TileRenderer.setupWireModel(BlockID.PipeOxygenLime,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenOrange,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenSilver,0, 2/8,"ob-wire");
ob.registerWire(BlockID.PipeOxygenWhite, 200);
...
TileRenderer.setupWireModel(BlockID.PipeOxygenRed,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenBrown,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenBlue,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenBlack,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenPink,0, 2/8,"ob-wire");
...
inCreative: true}]);
TileRenderer.setupWireModel(BlockID.PipeOxygenYellow,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenGreen,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenLightBlue,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenCyan,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenMagenta,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.PipeOxygenPurple,0, 2/8,"ob-wire");
...
TileRenderer.setupWireModel(BlockID.hydrogen_pipe,0, 2/8,"ob-wire");
