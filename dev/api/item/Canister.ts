class Canister extends GalacticraftItem implements IconOverrideCallback, INameOverrideCallback {
    public static liquidMax: number = 500;
    public static liquidList: string[] = [];
...
Callback.addCallback("ModsLoaded", () => {
    for(const fuel of Canister.liquidList) {
