...
Block.createBlock("brick",[{name: "Dungeon Brick", texture: [["Brick", 0]], inCreative: true} ],STONE);
Translation.addTranslation("Dungeon Brick",{
ru: "Крепостные кирпичи"
})

IDRegistry.genBlockID("dungeon_brick_venus_1");
Block.createBlock("dungeon_brick_venus_1",[{name: "Dungeon Brick Venus 1", texture: [["Dungeon Brick Venus 1", 0]], inCreative: true} ],STONE);
...
BlockRegistry.createBlock("dungeon_brick_venus_2",[{name: "Dungeon Brick Venus 2", texture: [["Dungeon Brick Venus 2", 0]], inCreative: true} ],STONE);
...
entry.addBox(7/16, 0/16, 7/16, 9/16, 10/16, 9/16) 
...
inCreative: false} ], WEB).create().placeableByItem("galactic_web")
...
Block.createBlock("oxygen_tile",[{name: "Oxygen Tile", texture: [["Oxygentile 3", 0]], inCreative: true} ],STONE);
...
Block.createBlock("venus_rock_2_slab",[{name: "Venus Rock 2 Slab", texture: [["Venus Rock 2", 0]], inCreative: true} ],STONE);
...
Block.createBlockWithRotation("venus_rock_0_slab",[{name: "Venus Rock 0 Slab", texture: [["Venus Rock 0", 0],["Venus Rock 0", 0],["Venus Rock 0", 0],["Venus Rock 0", 0],["Venus Rock 0", 0],["Venus Rock 0", 0]], inCreative: true} ],STONE);
...
Block.createBlock("lunar_stone_slab",[{name: "Lunar Stone Slab", texture: [["Lunar Stone", 0]], inCreative: true} ],STONE);
...
Block.createBlock("lunar_middle_slab",[{name: "Lunar Dirt Slab", texture: [["Middle", 0]], inCreative: true} ],STONE);
...
Block.createBlock("moon_top_side_slab",[{name: "Lunar Top Side Slab", texture: [["Top Side", 0],["Top", 0],["Top Side", 0],["Top", 0],["Top Side", 0],["Top Side", 0]], inCreative: true} ],STONE);
...
Block.createBlock("cobblestone_mars_slab",[{name: "The Martian Cobblestone Slab", texture: [["Cobblestone Mars", 0],["Cobblestone Mars", 0],["Cobblestone Mars", 0],["Cobblestone Mars", 0],["Cobblestone Mars", 0],["Cobblestone Mars", 0]], inCreative: true} ],STONE);
...
Block.createBlock("mars_middle_stone_slab",[{name: "The Martian Middle Stone Slab", texture: [["Middle Mars", 0]], inCreative: true} ],STONE);
...
Block.createBlock("mars_bottom_stone_slab",[{name: "The Martian Stone Bottom Slab", texture: [["Bottom Mars", 0]], inCreative: true} ],STONE);
...
Block.createBlock("mars_top_stone_slab",[{name: "The Martian Stone Top Slab", texture: [["Top Mars", 0]], inCreative: true} ],STONE);
