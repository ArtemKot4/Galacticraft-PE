...
IDRegistry.genItemID("emerald_shard"); 
Item.createItem("emerald_shard", "Emerald shard", {name: "Emerald shard", meta: 0}, {stack: 64});
...
IDRegistry.genItemID("compressed_lead"); 
Item.createItem("compressed_lead", "Compressed Lead", {name: "compressed_lead", meta: 0}, {stack: 64});

﻿
﻿IDRegistry.genItemID("ingot_bronze_sc"); 
Item.createItem("ingot_bronze_sc", "Ingot Bronze", {name: "ingot_bronze_sc", meta: 0}, {stack: 64});
...
IDRegistry.genItemID("ingot_lead_sc"); 
Item.createItem("ingot_lead_sc", "Ingot Lead", {name: "Ingot Lead", meta: 0}, {stack: 64});
...
﻿IDRegistry.genItemID("tin_shard"); 
Item.createItem("tin_shard", "Tin shard", {name: "tin_shard", meta: 0}, {stack: 64});

IDRegistry.genItemID("copper_shard"); 
Item.createItem("copper_shard", "Copper shard", {name: "copper_shard", meta: 0}, {stack: 64});
