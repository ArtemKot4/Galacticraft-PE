...
class SolarPanel extends Generator {
  ...
  onTick(): void {
    ...
    if (
      ...
      this.blockSource.getLightLevel(this.x, this.y + 1, this.z) == 15 &&
      this.data.energy != this.data.energyMax
    ) {
      this.data.energy += 1;
    }
    if (this.blockSource.getLightLevel(this.x, this.y + 1, this.z) >= 2) {
      this.container.setText(
        "LightLevel",
    ...
    if (
      ...
      this.blockSource.getLightLevel(this.x, this.y + 1, this.z) <= 1 &&
      this.data.energy <= 1
    ) {
