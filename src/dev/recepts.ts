...
SpacesMachine.addCoal({coal: VanillaItemID.coal});
SpacesMachine.addCoal({coal: VanillaItemID.charcoal});
SpacesMachine.addCoal({coal: ItemID.burned_coal});
SpacesMachine.addCoal({coal: VanillaBlockID.coal_block});
...
SpacesCraft.addSHIFTtext(BlockID.mekanism_block, "Used for create \nindustrial machines")



SpacesCraft.addSHIFTtext(BlockID.mekanism_block_ports, "Used for create \nindustrial machines")



SpacesCraft.addSHIFTtext(BlockID.mekanism_block_ports_1, "Used for create \nindustrial machines")

SpacesCraft.addSHIFTtext(BlockID.advanced_mekanism_block_ports_1, "Used for create \nindustrial machines")

SpacesCraft.addSHIFTtext(BlockID.advanced_mekanism_block, "Used for create \nindustrial machines")

SpacesCraft.addSHIFTtext(BlockID.Pad_Normal, "Place blocks 3x3\nfor create rocket padding")
...
SpacesCraft.addSHIFTtext(ItemID.motherboard_sc, "Need for programming programm to workbench nasa")

SpacesCraft.addSHIFTtext(ItemID.chip_industrialization, "Need for programming programm to workbench nasa")
}
...
Recipes.addShaped({id: BlockID.compressor_sj, count: 1, data: 0}, [
    ...
    "aca",
    "aea"
], ['a', ItemID.ingot_aluminum_sc, 0, 'b', VanillaBlockID.anvil, 0, 'c', ItemID.ingot_copper_sc, 0, 'e', ItemID.wafer_basic, 0,'f',BlockID.mekanism_block_ports,0]);
//Компрессор
Recipes.addShaped({id: BlockID.Pad_Normal, count: 1, data: 0}, [
    "aaa",
    "bbb",
    ""
...
Recipes.addShaped({id: BlockID.mekanism_block, count: 1, data: 0}, [
    "bab",
    "aca",
    "bab"
...
Recipes.addShaped({id: 354, count: 1, data: 0}, [
    ...
    "bcb",
    "ddd"
], ['a',VanillaItemID.milk_bucket, 0, 'b', ItemID.blue_sugar_sc, 0,'c',344, 0,'d',296,0]);
//торт
...
Recipes.addShaped({id: BlockID.basic_solar_panel, count: 1, data: 0}, [
    ...
    'c',BlockID.mekanism_block_ports_1,0,
...
Recipes.addShaped({id: BlockID.fuel_loader, count: 1, data: 0}, [
    ...
    "ada",
    "ebe"
], ['a', ItemID.compressed_steel, 0, 'b', ItemID.wafer_basic, 0, 'c', BlockID.mekanism_block_ports_1, 0, 'd', ItemID.canister_tin, 0,'e',ItemID.compressed_tin,0]);
