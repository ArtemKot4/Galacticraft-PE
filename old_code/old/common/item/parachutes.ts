...
// ﻿IDRegistry.genItemID("parachute_dark_blue"); 
// Item.createItem("parachute_dark_blue", "Parachute Darkblue", {name: "Parachute Darkblue", meta: 0}, {stack: 1});
// Translation.addTranslation("Parachute Darkblue", {
// ru: "Синий парашют"
// });

// IDRegistry.genItemID("parachute_dark_gray"); 
// Item.createItem("parachute_dark_gray", "Parachute Darkgray", {name: "Parachute Darkgray", meta: 0}, {stack: 1});
// Translation.addTranslation("Parachute Darkgray", {
// ru: "Тёмно-серый парашют"
// });

// ﻿IDRegistry.genItemID("parachute_dark_green"); 
// Item.createItem("parachute_dark_green", "Parachute Darkgreen", {name: "Parachute Darkgreen", meta: 0}, {stack: 1});
...
// ﻿IDRegistry.genItemID("parachute_pink"); 
// Item.createItem("parachute_pink", "Parachute Pink", {name: "Parachute Pink", meta: 0}, {stack: 1});
// Translation.addTranslation("Parachute Pink", {
// ru: "Розовый парашют"
// });
