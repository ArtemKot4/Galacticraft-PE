class CompressorTile extends ProcessingMachine {
    ...
    public onTick(): void {
        ...
        ShapedRecipeFactory.get<CoalRecipeFactory>("gc:coal_generator").link("coal_slot", this);
        
        const recipe = RecipeFactory.get<ShapedRecipeFactory>("gc:compressor").getRecipeByMore(this.container, 9);
